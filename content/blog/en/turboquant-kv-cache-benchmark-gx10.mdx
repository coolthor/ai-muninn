...
faq:
  ...
  - q: "Is TurboQuant faster than standard KV cache on GB10 (DGX Spark)?"
    a: "No, not currently. The community PyTorch implementation has no fused CUDA kernel — inner product takes 11ms vs 0.02ms for full-precision matmul. The paper's 8x speedup was measured on H100 with optimized kernels. Memory savings are real on GB10; speed gains require upstream kernel support, expected with vLLM PR #38280."
  - q: "When will TurboQuant be usable in production with vLLM?"
    a: "vLLM PR #38280 is under review as of March 2026. Once merged, it would enable --kv-cache-dtype turboquant3 as a server flag. llama.cpp has community forks but nothing merged to main. Official implementation expected Q2 2026."
---
...
**Not in production.** vLLM PR [#38280](https://github.com/vllm-project/vllm/issues/38171) is under review. llama.cpp has multiple community forks but nothing merged to main. Official implementation expected Q2 2026.
