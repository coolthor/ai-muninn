...
**Add about 1-2 GB for working memory** (the model also needs space to actually think while running — technically called the KV cache, but you don't need to know the term).
