...
[Z-Image Turbo](https://huggingface.co/Comfy-Org/z_image_turbo) is an open-source image generation model released by Alibaba's Tongyi-MAI team in late November 2025. The distilled variant generates images in just 8 sampling steps. Apache 2.0 licensed, fine for commercial use, fully self-host.
