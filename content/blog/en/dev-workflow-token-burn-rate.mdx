...
Run `/context` right now. You might discover that one MCP server is consuming 18K tokens, or that your CLAUDE.md is bigger than you thought. Fix the biggest offender first — that's worth more than all the other tips combined.
...
*Fixes 0-7 above are enough for most people. Parts 4 and 5 are for power users who work with hundreds of notes across sessions. Full disclosure: I built [Musubi](https://github.com/coolthor/musubi), one of the tools mentioned below.*
