---
title: "[vLLM] gpt-oss-120B at 59 tok/s: 6 Pitfalls and a Working Serve Script"
...
Same hardware, different model, different problem set. After getting [SM121 NVFP4 working](/en/blog/part1-why-your-dgx-spark-says-exclamation-marks), the natural next question is: what else can this machine run? gpt-oss-120B is Microsoft's open-source 120B model — a different quantization format, a different tokenizer, and its own category of silent failures.
...
`--enforce-eager` should never be in a production serve script. If you inherited a script and the speed is wrong, check for this flag first. It's an easy 2× regression to introduce and forget.
