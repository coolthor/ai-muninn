...
description: "Moving from Ollama to vLLM on a DGX Spark (GB10, 128GB). Prefix caching drops TTFT from seconds to 0.12s. Six gotchas: thinking mode, memory fights, docker restart, warmup, SSM + chunked prefill, and parameter coupling."
date: "2026-03-05"
