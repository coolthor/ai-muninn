...
![NVFP4 W4A16 vs W4A4 decode paths on GB10: shared LPDDR5X memory bus on top, two parallel pipelines below. W4A16 path loads NVFP4 weight, dequantizes to BF16 on-chip, runs BF16 GEMM with the FP4 tensor core idle, and wins single-stream at 74.75 tok/s. W4A4 path loads the same NVFP4 weight, then quantizes activations BF16→FP4 per step, runs the actual FP4×FP4 mma.kind::mxf4nvf4 tensor core MMA, and wins multi-batch at 786 tok/s aggregate.](/images/nvfp4-w4a16-vs-w4a4-paths.png)
