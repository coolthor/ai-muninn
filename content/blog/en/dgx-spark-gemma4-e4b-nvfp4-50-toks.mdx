...
Gemma 4 is a family of open-source AI models released by Google in April 2026. The E4B variant is the small one — designed to run on phones and desktops instead of data center GPUs. It can read text, images, and audio, and it supports 128K tokens of context (roughly a 300-page book).
