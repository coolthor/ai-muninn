...
Gemma 4 is a family of open-source AI models released by Google in April 2026. It comes in four sizes: E2B (smallest), E4B, 26B MoE, and 31B dense. E4B is the mid-range edge model — small enough for phones and desktops, capable enough to be useful. It can read text, images, and audio, and it supports 128K tokens of context (roughly a 300-page book).
