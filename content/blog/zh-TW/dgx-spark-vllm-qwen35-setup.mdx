...
description: "在 DGX Spark（GB10，128GB）上從 Ollama 換到 vLLM。Prefix caching 讓 TTFT 從幾秒降到 0.12s。六個坑：thinking mode、記憶體衝突、docker 重啟、warmup、SSM + chunked prefill，以及參數耦合。"
date: "2026-03-05"
