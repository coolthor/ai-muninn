...
[Z-Image Turbo](https://huggingface.co/Comfy-Org/z_image_turbo) 是 Alibaba 通義(Tongyi-MAI)2025 年 11 月底發布的開源 image gen 模型。distilled 版只要 8 step 就能生圖。Apache 2.0 商用 OK,Self-host 全套自架。
