...
Gemma 4 是 Google 在 2026 年 4 月發布的開源 AI 模型家族，共四種大小：E2B（最小）、E4B、26B MoE、31B dense。E4B 是中間偏小的 edge 模型 — 小到手機和桌機能跑，但能力足夠實用。它能讀文字、看圖片、聽音訊，支援 128K tokens 的上下文（大約一本 300 頁的書）。
