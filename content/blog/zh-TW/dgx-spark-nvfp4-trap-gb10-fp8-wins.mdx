...
faq:
  - q: "為什麼 NVFP4 在 DGX Spark GB10 上比 FP8 慢？"
    a: "GB10 的 SM121 GPU 缺少 cvt.rn.satfinite.e2m1x2.f32 這條 PTX 指令，無法原生做 FP4↔FP32 轉換。RTX 5090 (SM120) 和 B200 (SM100) 有硬體支援。SM121 上 NVFP4 只能走 Marlin fallback（40.8 tok/s，-21%）或直接 crash。這是矽片限制，driver 更新修不了。"
...
關鍵差異：SM121 沒有 `cvt.rn.satfinite.e2m1x2.f32` 這條 [PTX 指令](https://docs.nvidia.com/cuda/parallel-thread-execution/index.html)。這條指令負責在硬體層做 FP4 (e2m1) ↔ FP32 的轉換——SM120/SM100 上一個 clock cycle 搞定。
