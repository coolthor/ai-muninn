---
title: "30 分鐘搞定 NemoClaw 安裝：DGX Spark 完整教學"
description: "在 DGX Spark（GX10, GB10）上安裝 NVIDIA NemoClaw 的完整指南。涵蓋 Docker cgroup v2 修復、OpenShell 設定、Node 升級，以及每個踩坑點。30 分鐘內跑起第一個 Agent。2026 年更新。"
date: "2026-03-23"
